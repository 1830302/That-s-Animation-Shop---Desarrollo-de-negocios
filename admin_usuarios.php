...
$db = getPDO();
$consulta_lista= $db->prepare('SELECT * FROM users');
...
<!-- APARTADO DEL CONTENIDO-->
	...
	<div class="content">
		...
		<button class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#formAgregar">Agregar usuarios</button>
	</div>
		  		...
		  		<table id="tablaProductos" class="table table-striped table-bordered text-center" style="width:100%">
					...
					<tbody>
					  	...
					  	<?php foreach ($lista as $list) {
					  		...
					  		$info=$list['id'].'-'.$list['name'].'-'.$list['nickname'].'-'.$list['pass'].'-'.$list['image'];
					  		?>
					    <tr>
					      ...
					      <td> <img width="50px" src="<?php echo $list['image']; ?>" ></td>
					      <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="adm_users/add.php" class="form-add form-group" enctype="multipart/form-data">
        	<label>Nombre:</label>
        	<input type="text" placeholder="Nombre" name="name" required/><br>

        	<label class="mt-2">Nickname:</label>
        	<input type="text" placeholder="Nickname" name="nickname" step="any" required/><br>

        	<label class="mt-2">Contraseña:</label>
        	<input type="number" placeholder="Contraseña" name="pass" required/>
...
<div class="modal fade" id="formEditar" tabindex="-1" aria-labelledby="formEditar" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="adm_users/update.php" class="form-edit form-group" enctype="multipart/form-data">
        	...
        	<label class="mt-2">Nickname:</label>
        	<input type="text" placeholder="Nickname" name="nickname" id="nickname" step="any" required/><br>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body msg-text">
      	<form method="POST" action="adm_users/delete.php">
