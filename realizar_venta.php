		  		...
		  		<table id="tablaProductos" class="table table-striped table-bordered text-center" style="width:100%">
					...
					<tbody>
					    ...
					    <tr>
                          ...
                          <td><?php echo $list['direccion_de_entrega']; ?></td>
                          <td><?php echo $list['telefono_del_comprador']; ?></td>
                          <td><?php echo $list['nombre_del_producto']; ?></td>
                          <td><?php echo $list['fecha']; ?></td>
                          <td><?php echo $list['total']; ?></td>
					      <td> <img width="50px" src="<?php echo $list['imagen']; ?>" ></td>
					      <td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="adm_ventas/update.php" class="form-edit form-group" enctype="multipart/form-data">
            ...
            <label>Nombre:</label>
            <input type="text" placeholder="Nombre del comprador" name="name" id="A1" required/><br>

            <label>Forma de pago:</label>
            <input type="text" placeholder="Forma de pago" name="pago" id="A2" required readonly/><br>

            <label>Dirección de entrega:</label>
            <input type="text" placeholder="Dirección de entrega" name="direccion"  id="A3" required/><br>

            <label>Teléfono del comprador:</label>
            <input type="number" placeholder="Teléfono del comprador" name="telefono" id="A4" required/><br>

            <label>Nombre del producto:</label>
            <input type="text" placeholder="Nombre del producto" name="producto" id="A5" required readonly /><br>

            <label>Total:</label>
            <input type="number" placeholder="Total" name="total" id="A7" required/><br>
